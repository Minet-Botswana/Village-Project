...
urlpatterns = [
    ...
    path('motor-insurance-requirement/', views.motor_insurance_requirement_view, name='motor-insurance-requirement'),
    ...
    path('edit-question/<int:question_id>/', views.edit_question_view, name='edit-question'),
    path('delete-question/<int:question_id>/', views.delete_question_view, name='delete-question'),
    ...
    path('policy-wordings/', views.customer_policy_wordings_view, name='policy-wordings'),
    path('forms/', views.client_forms, name='client_forms'),
    
    path('form/direct_debit/', views.direct_debit_view, name='direct_debit'),
    path('form/homeowners_insurance/', views.homeowners_insurance_view, name='homeowners_insurance'),
    path('forms/motor_insurance/', views.motor_insurance_view, name='motor_insurance'),
    path('success/', views.success_page, name='success_page'),
    
    path('create_homeowners_cover/', views.create_homeowners_cover, name='create_homeowners_cover'),
    path('create_thirdpartycar_cover/', views.create_thirdpartycar_cover, name='create_thirdpartycar_cover'),
    path('upload_kyc_form/', views.upload_kyc_form, name='upload_kyc_form'),
    path('upload_omang_form/', views.upload_copy_of_omang, name='upload_copy_of_omang'),
    path('upload_residence_proof/', views.upload_residence_proof, name='upload_residence_proof'),
    path('upload_income_proof/', views.upload_income_proof, name='upload_income_proof'),
